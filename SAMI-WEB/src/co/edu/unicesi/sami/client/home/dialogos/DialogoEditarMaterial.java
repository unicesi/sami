...
public class DialogoEditarMaterial extends Dialog {
	...
	public void cargarDatos(MaterialModel material) {
		...
		txtAutor.setValue(material.getAutor());
		txtTitulo.setValue(material.getTitulo());
		txtAno.setValue(material.getAno());
		txtCiudad.setValue(material.getCiudad());
		txtEditorial.setValue(material.getEditorial());
		show();
	}
}
